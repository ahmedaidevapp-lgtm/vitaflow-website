      ...
      <div className="container">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-center">
          ...
          <div className="bg-primary-light border border-greenBorder rounded-[20px] p-9">
            ...
            <div className="font-display text-[30px] font-bold text-navy">{trust.cardTitle}</div>
          ...
          <div>
            ...
            <p className="text-[16px] leading-[1.6] text-slate1 mb-6">{trust.body}</p>

            {/* Disclaimer */}
            <div className="flex items-start gap-4 bg-[#FBF8F3] border border-[#F0E6D0] rounded-xl p-5">
              <svg
                viewBox="0 0 24 24"
                className="w-5 h-5 text-[#C77A18] stroke-current fill-none shrink-0 mt-0.5"
                strokeWidth={2.25}
                strokeLinecap="round"
                strokeLinejoin="round"
                aria-hidden
              ...
              <div>
                <p className="text-[14px] font-semibold text-navy mb-0.5">{trust.disclaimerTitle}</p>
                <p className="text-[13.5px] text-slate1 leading-relaxed">{trust.disclaimerBody}</p>
              </div>
            </div>
          </div>
        </div>
